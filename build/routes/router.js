...
router.get("/miperfil", validateToken_js_1.validateToken, getStudentProfile_js_1.getStudentProfile);
...
router.get('/puntos', validateToken_js_1.validateToken, (req, res) => {
    res.render("puntos");
});
...
router.get("/misPuntosRecibidos", validateToken_js_1.validateToken, incomingPoints_js_1.incomingPoints);
router.get("/scores", getRanking_js_1.getRanking);
router.get("/ranking", validateToken_js_1.validateToken, getRanking_PointsList_js_1.getRankingList);
